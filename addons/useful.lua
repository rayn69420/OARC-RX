...
local function shared_chests_spawn_input(pos)
    protect_entity(game.player.surface.create_entity{name="storage-chest", force=game.forces["shared"], position=pos})
end
local function shared_chests_spawn_output(pos)
    protect_entity(game.player.surface.create_entity{name="requester-chest", force=game.forces["shared"], position=pos})
end
...
local function create_sell_chest(pos)
    protect_entity(game.player.surface.create_entity{name="buffer-chest", force=game.forces["shared"], position=pos})
end

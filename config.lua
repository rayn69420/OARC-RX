...
-- Enable autofill turrets from shared system every second
-- ENABLE_CONTINUOUS_AUTOFILL = true
...
OARC_CFG = {
    ...
    resource_rand_pos_settings =
    {
        ...
        angle_offset = 2.285, -- 2.285 is approx SSW.
        -- At what angle do we place the last resource.
        -- angle_offset and angle_final determine spacing and placement.
        angle_final = 4.57 -- 4.57 is approx NNW.
    },
...
-- Shared force is what the sharing chests/accumulators are in
-- SHARED_FORCE = "shared"
